...
def generate_keys(mode="F"):
    # F:Fast, S:Secure (Fast it will be 2048 while Secure it will be 4096)
    if (mode == "F"):
...
def verify_fileRSA(file_name, public_key):
    ...
    try:
        ...
        return "Signature verified: Message has not been tampered with."
    except rsa.VerificationError:
        print("Verification failed: File has been tampered with.")
        return "Verification failed: File has been tampered with."
